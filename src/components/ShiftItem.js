...
import { takenShiftRef, shiftRef, userRef } from '../firebase';
...
class ShiftItem extends Component {
  ...
  render() {
    const { beginTime, endTime, date, email, fullName, jobClass, meal, notes, offerSwap, pNumber, signed } = this.props.shift;
    return (
